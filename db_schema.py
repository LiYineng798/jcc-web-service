...
EXTRA_INDEX_STATEMENTS = (
    ...
    'CREATE INDEX IF NOT EXISTS idx_live_comp_upload_jobs_status_created_at ON live_comp_upload_jobs (status, created_at)',
    'CREATE INDEX IF NOT EXISTS idx_live_comp_upload_jobs_created_by_created_at ON live_comp_upload_jobs (created_by, created_at DESC)',
)
